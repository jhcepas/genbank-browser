/*! Genome Viewer - v1.0.3 - 2013-12-01 17:47:57
...
//        setTimeout(checkStatus, 10);
    ...
    setRegionDirect: function (region) {
        this.region.load(region);
        this.setMinRegion(this.region, this.getSVGCanvasWidth());
        this.trigger('region:change', {region: this.region, sender: this});
    },
    _checkRegion: function (newRegion) {
        ...
        console.log(newRegion, "regions");
        if(newRegion.chromosome !== this.region.chromosome){
            newRegion.start = 0; //Math.round(newChr.size/2);
            newRegion.end =  9999; //Math.round(newChr.size/2);
        }
        return newRegion;
    },
