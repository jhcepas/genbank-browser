/*! Genome Viewer - v1.0.2 - 2013-11-20
...
function FeatureTrack(args) {
    ...
    //save default render reference;
    this.defaultRenderer = this.renderer;
    this.histogramRenderer = new FeatureClusterRenderer(args);
//    this.histogramRenderer = new HistogramRenderer();
...
//            var height = Math.log(features[i].absolute);
        ...
        var getInfo = function (feature) {
            var resp = '';
            return resp += Math.round(feature.features_count *100, 2) + "%";
...
//         });
        ...
        $(rect).qtip({
            content: {text: "", title: getInfo(feature)},
